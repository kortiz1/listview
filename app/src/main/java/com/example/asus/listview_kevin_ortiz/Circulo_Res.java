...
public class Circulo_Res extends AppCompatActivity {
   ...
   private TextView resp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.circulo_resp);
        resp = (TextView)findViewById(R.id.LblCCi);
